...
\begin{theorem}
  ...
  \item $\mat{P}_{\mU,\mV}$ is a minimal left generator for the
    sequence $\seqL_{\mU} = (\mUt \mM^s)_{s \ge 0}$;
...
\begin{proof}
  ...
  $\seqL_{\mU} = (\mUt\mM^s)_{s \ge 0}$; this sequence is
  linearly generated as well, and we let $\mat{P}_{\mU}$ be the
  canonical left generator for it.  We denote by $\langle \mU \rangle$
  the vector space generated by the rows of $\mUt,\mUt \mM,
  \mUt{\mM^2},\dots$, and we write $D_\mU=\dim(\langle \mU
  \rangle)$.
