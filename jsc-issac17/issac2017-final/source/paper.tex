...
\newcommand{\remSpace}{\polMatSpace[1][\rdim]} % space for linear relations
...
% In what follows, for an $r \times s$ matrix
...
Alonso, M.~E., Becker, E., Roy, M.-F., W{\"o}rmann, T., 1996. Zeroes,
  multiplicities and idempotents for zero-dimensional systems. In: MEGA'94.
  Vol. 142 of Progress in Mathematics. Birkh{\"a}user, pp. 1--15.

\bibitem[{Bardet et~al.(2015)Bardet, Faug{\`e}re, and Salvy}]{BaFaSa15}
Bardet, M., Faug{\`e}re, J.-C., Salvy, B., 2015. On the complexity of the {F}5
  {G}r{\"o}bner basis algorithm. J. Symbolic Comput. 70, 49--70.

\bibitem[{Becker et~al.(1994)Becker, Mora, Marinari, and Traverso}]{BeMoMaTr94}
Becker, E., Mora, T., Marinari, M., Traverso, C., 1994. The shape of the
  {S}hape {L}emma. In: ISSAC'94. ACM, pp. 129--133.

\bibitem[{Becker and W{\"o}rmann(1996)}]{BeWo96}
Becker, E., W{\"o}rmann, T., 1996. Radical computations of zero-dimensional
  ideals and real root counting. Mathematics and Computers in Simulation
  42~(4-6), 561--569.

\bibitem[{Beckermann and Labahn(1994)}]{BecLab94}
Beckermann, B., Labahn, G., 1994. A uniform approach for the fast computation
  of matrix-type {P}ad\'e approximants. SIAM J. Matrix Anal. Appl. 15~(3),
  804--823.

\bibitem[{Bosma et~al.(1997)Bosma, Cannon, and Playoust}]{BoCaPl97}
Bosma, W., Cannon, J., Playoust, C., 1997. The {M}agma algebra system. {I}.
  {T}he user language. J. Symbolic Comput. 24~(3-4), 235--265.

\bibitem[{Bostan et~al.(2006)Bostan, Flajolet, Salvy, and Schost}]{BoFlSaSc06}
Bostan, A., Flajolet, P., Salvy, B., Schost, {\'E}., 2006. Fast computation of
  special resultants. J. Symbolic Comput. 41~(1), 1--29.

\bibitem[{Bostan et~al.(2003)Bostan, Salvy, and Schost}]{BoSaSc03}
Bostan, A., Salvy, B., Schost, {\'E}., 2003. Fast algorithms for
  zero-dimensional polynomial systems using duality. Appl. Algebra Engrg. Comm.
  Comput. 14, 239--272.

\bibitem[{Brent et~al.(1980)Brent, Gustavson, and Yun}]{BrGuYu80}
Brent, R.~P., Gustavson, F.~G., Yun, D. Y.~Y., 1980. Fast solution of
  {Toeplitz} systems of equations and computation of {Pad\'e} approximants.
  Journal of Algorithms 1~(3), 259--295.

\bibitem[{Coppersmith(1994)}]{Coppersmith94}
Coppersmith, D., 1994. Solving homogeneous linear equations over {GF}$(2)$ via
  block {W}iedemann algorithm. Math. Comp. 62~(205), 333--350.

\bibitem[{Faug\`ere(2002)}]{Faugere02}
Faug\`ere, J.-C., 2002. A new efficient algorithm for computing {G}r\"obner
  bases without reductions to zero ({F}5). In: ISSAC'02. ACM, pp. 75--83.

\bibitem[{Faug{\`e}re et~al.(2013)Faug{\`e}re, Gaudry, Huot, and
  Renault}]{FaGaHuRe13}
Faug{\`e}re, J.-C., Gaudry, P., Huot, L., Renault, G., 2013. {Polynomial
  systems solving by fast linear algebra}.
  \url{https://hal.archives-ouvertes.fr/hal-00816724}.

\bibitem[{Faug\`{e}re et~al.(2014)Faug\`{e}re, Gaudry, Huot, and
  Renault}]{FaGaHuRe14}
Faug\`{e}re, J.-C., Gaudry, P., Huot, L., Renault, G., 2014. Sub-cubic change
  of ordering for {G}r{\"o}bner basis: a probabilistic approach. In: ISSAC'14.
  ACM, pp. 170--177.

\bibitem[{Faug\`ere et~al.(1993)Faug\`ere, Gianni, Lazard, and
  Mora}]{FaGiLaMo93}
Faug\`ere, J.-C., Gianni, P., Lazard, D., Mora, T., 1993. Efficient computation
  of zero-dimensional {G}r\"obner bases by change of ordering. J. Symbolic
  Comput. 16~(4), 329--344.

\bibitem[{Faug{\`e}re and Mou(2017)}]{FaMo17}
Faug{\`e}re, J.-C., Mou, C., 2017. Sparse {FGLM} algorithms. J. Symbolic
  Comput. 80~(8), 538--569.

\bibitem[{Faug\`ere et~al.(2013)Faug\`ere, {Safey El Din}, and
  Spaenlehauer}]{FaSaSp13}
Faug\`ere, J.-C., {Safey El Din}, M., Spaenlehauer, P.-J., 2013. On the
  complexity of the generalized {M}in{R}ank problem. J. Symbolic Comput.,
  30--58.

\bibitem[{Gianni and Mora(1989)}]{GiMo89}
Gianni, P., Mora, T., 1989. Algebraic solution of systems of polynomial
  equations using {G}r\"obner bases. In: AAECC'5. No. 356 in Lecture Notes in
  Comput. Sci. Springer, pp. 247--257.

\bibitem[{Giorgi et~al.(2003)Giorgi, Jeannerod, and Villard}]{GiJeVi03}
Giorgi, P., Jeannerod, C.-P., Villard, G., 2003. On the complexity of
  polynomial matrix computations. In: ISSAC'03. ACM, pp. 135--142.

\bibitem[{Giorgi and Lebreton(2014)}]{GioLeb14}
Giorgi, P., Lebreton, R., 2014. Online order basis algorithm and its impact on
  the block {W}iedemann algorithm. In: ISSAC'14. ACM, pp. 202--209.

\bibitem[{Guennebaud et~al.(2018)Guennebaud, Jacob, et~al.}]{Eigen}
Guennebaud, G., Jacob, B., et~al., 2018. Eigen, version 3.3.7.
...
Kaltofen, E., 1995. Analysis of {Coppersmith}'s block {Wiedemann} algorithm for
  the parallel solution of sparse linear systems. Mathematics of Computation
  64~(210), 777--806.

\bibitem[{Kaltofen and Villard(2001)}]{KalVil01}
Kaltofen, E., Villard, G., 2001. On the complexity of computing determinants.
  In: ISSAC'01. ACM, pp. 13--27.

\bibitem[{Kaltofen and Villard(2004)}]{KaVi04}
Kaltofen, E., Villard, G., 2004. On the complexity of computing determinants.
  Comput. Complexity 13~(3-4), 91--130.

\bibitem[{Keller-Gehrig(1985)}]{Keller85}
Keller-Gehrig, W., 1985. Fast algorithms for the characteristic polynomial.
  Theoret. Comput. Sci. 36~(2-3), 309--317.

\bibitem[{LaMacchia and Odlyzko(1990)}]{LaOd90}
LaMacchia, B.~A., Odlyzko, A.~M., 1990. Solving large sparse linear systems
  over finite fields. In: Adv. in Cryptography, Crypto '90. No. 537 in Lectures
  Notes in Computer Science. Springer, pp. 109--133.

\bibitem[{Macaulay(1916)}]{Macaulay16}
Macaulay, F.~S., 1916. The Algebraic Theory of Modular Systems. Cambridge
  University Press.

\bibitem[{Marinari et~al.(1996)Marinari, M{\"o}ller, and Mora}]{MaMoMo96}
Marinari, M.~G., M{\"o}ller, H.~M., Mora, T., 1996. On multiplicities in
  polynomial system solving. Trans. Amer. Math. Soc. 348~(8), 3283--3321.

\bibitem[{Moreno-Soc{\'\i}as(1991)}]{MorenoSocias91}
Moreno-Soc{\'\i}as, G., 1991. Autour de la fonction de {H}ilbert-{S}amuel
  (escaliers d'id{\'e}aux polynomiaux). Ph.D. thesis, \'Ecole polytechnique.

\bibitem[{Morgan(1988)}]{Morgan88}
Morgan, A., 1988. Solving Polynominal Systems Using Continuation for
  Engineering and Scientific Problems. Prentice-Hall.

\bibitem[{Mourrain(1997)}]{Mourrain97}
Mourrain, B., 1997. Isolated points, duality and residues. Journal of Pure and
  Applied Algebra 117/118, 469--493.

\bibitem[{Neiger(2016)}]{Neiger16}
Neiger, V., Nov. 2016. {Bases of relations in one or several variables: fast
  algorithms and applications}. Ph.D. thesis, {{\'E}cole Normale Sup{\'e}rieure
  de Lyon}.

\bibitem[{Neiger et~al.(2017)Neiger, Rahkooy, and Schost}]{NeRaSc17}
Neiger, V., Rahkooy, H., Schost, {\'{E}}., 2017. Algorithms for
  zero-dimensional ideals using linear recurrent sequences. In: CASC'17.
  Springer, pp. 313--328.

\bibitem[{Poteaux and Schost(2013)}]{PoSc13b}
Poteaux, A., Schost, E., 2013. On the complexity of computing with
  zero-dimensional triangular sets. J. Symbolic Comput. 50, 110--138.

\bibitem[{Rouillier(1999)}]{Rouillier99}
Rouillier, F., 1999. Solving zero-dimensional systems through the {R}ational
  {U}nivariate {R}epresentation. Appl. Algebra Engrg. Comm. Comput. 9~(5),
  433--461.

\bibitem[{Sakata(1990)}]{Sakata90}
Sakata, S., 1990. Extension of the {B}erlekamp-{M}assey algorithm to {$N$}
  dimensions. Information and Computation 84~(2), 207--239.

\bibitem[{Shoup(1994)}]{Shoup94}
Shoup, V., 1994. Fast construction of irreducible polynomials over finite
  fields. J. Symbolic Comput. 17~(5), 371--391.

\bibitem[{Shoup(1999)}]{Shoup99}
Shoup, V., 1999. Efficient computation of minimal polynomials in algebraic
  extensions of finite fields. In: ISSAC'99. ACM, pp. 53--58.

\bibitem[{Shoup(2018)}]{NTL}
Shoup, V., 2018. {NTL}: A library for doing number theory, version 11.3.2.
  \texttt{http://www.shoup.net}.

\bibitem[{Steel(2015)}]{Steel15}
Steel, A., 2015. Direct solution of the (11,9,8)-{M}in{R}ank problem by the
  block {W}iedemann algorithm in {M}agma with a {T}esla {GPU}. In: PASCO'15.
  ACM, pp. 2--6.

\bibitem[{Storjohann(2003)}]{Stor03}
Storjohann, A., 2003. High-order lifting and integrality certification. J.
  Symbolic Comput. 36, 613--648.

\bibitem[{{The~FFLAS-FFPACK~Group}(2019)}]{fflas-ffpack}
{The~FFLAS-FFPACK~Group}, 2019. {FFLAS-FFPACK}: {F}inite {F}ield {L}inear
  {A}lgebra {S}ubroutines / {P}ackage, version 2.3.2.
  \url{http://github.com/linbox-team/fflas-ffpack}.

\bibitem[{{The LinBox Group}(2018)}]{LinBox}
{The LinBox Group}, 2018. Linbox: Linear algebra over black-box matrices,
  version 1.5.3. \url{https://github.com/linbox-team/linbox/}.

\bibitem[{Turner(2002)}]{Turner02}
Turner, W.~J., 2002. {Black box linear algebra with the LINBOX library}. Ph.D.
  thesis, {North Carolina State University}.

\bibitem[{Van~Barel and Bultheel(1992)}]{BarBul92}
Van~Barel, M., Bultheel, A., 1992. A general module theoretic framework for
  vector {M-Pad\'e} and matrix rational interpolation. Numer. Algorithms 3,
  451--462.

\bibitem[{Villard(1997{\natexlab{a}})}]{Villard97}
Villard, G., 1997{\natexlab{a}}. Further analysis of {C}oppersmith's block
  {W}iedemann algorithm for the solution of sparse linear systems. In:
  ISSAC'97. ACM, pp. 32--39.

\bibitem[{Villard(1997{\natexlab{b}})}]{Villard97a}
Villard, G., 1997{\natexlab{b}}. A study of {C}oppersmith's block {W}iedemann
  algorithm using matrix polynomials. Tech. rep., LMC-IMAG, Report 975 IM.

\bibitem[{von~zur Gathen and Gerhard(2013)}]{GaGe13}
von~zur Gathen, J., Gerhard, J., 2013. Modern Computer Algebra, 3rd Edition.
  Cambridge University Press, Cambridge.

\bibitem[{Wiedemann(1986)}]{Wiedemann86}
Wiedemann, D., 1986. Solving sparse linear equations over finite fields. IEEE
  Trans. Inf. Theory IT-32, 54--62.

\bibitem[{Wolovich(1974)}]{Wolovich74}
Wolovich, W.~A., 1974. Linear Multivariable Systems. Vol.~11 of Applied
