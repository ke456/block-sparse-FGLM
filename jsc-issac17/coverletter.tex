...
appendix, to streamline Section 2.

A few other minor corrections were made in the paper (mostly typos). Altogether
We hope you will find the new version more readable (we certainly do).
