def eval(x1, x2, x3, x4, x5):
        return [65532*x1 + x2 + x4 + 65532*x5, 5*x1 + 65533*x2 + 65532*x3 + 4*x4 + x5, 65532*x1 + 2*x2 + 65536*x3 + 5*x4 + 65534*x5, 65536*x1^5 + 5*x1*x2*x3*x4*x5 + 65536*x2^5 + 65536*x3^5 + 65536*x4^5 + 
