...
and the number of points separated by $X_1$. In the worst case, if the density
...
$\mainalgoname$. However, this was not observed in our experiments.
For all our inputs, with the exception of sot1, $X_1$ separates most of the points in
the variety. In this case, $\mathsf{Parametrization}$ performs better by
a factor of 2 compared to $\mainalgoname$ on average for all values of $m$. Even in
an unfavourable case like sot1, where $X_1$ only separates $1012$ points out of
$7682$ points in the variety, the ratio is close to 1.

\begin{center}
\textbf{Comparison of $\mathsf{ParametrizationX}_1$ to $\mainalgoname$}
