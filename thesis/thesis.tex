...
products. Our implementation is dedicated to small prime fields; we
store our multiplication matrices using Eigen's {\tt
  SparseMatrix<double>} class
 ...
 and polynomial
matrix multiplication. All timings are measured on an Intel i7-4790
CPU with 32 GB RAM and 8 CPU's. For each value of $m$, we create and
run $m$ threads in parallel.
