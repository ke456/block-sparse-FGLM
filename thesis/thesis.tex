...
\begin{proof}
  ...
  row of this matrix, our first claim follows. Furthermore, the bound on the
  degree of the entries of $\row{a}_i$ is a direct consequence of Cramer's
  formulas.
\end{proof}
