...
of degree less than $deg(P)$. Therefore, if $A' = Z'P$ and $B' = \tilde B = P$, then we
can write $Z' = A'/B'$.
...
\begin{definition}
	...
	to $P$ if:
	\begin{itemize}
		\item $\Omega(Z,P)$ is a polynomial of degree less than $deg(P)$
		\item $Z = \Omega(Z,P)/P$
	\end{itemize}
\end{definition}
\noindent Let $A$ and $A'$ be defined as above, then 
$\Omega(Z,{\rm rev}(P)) = A$ and $\Omega(Z',P) = A'$. Finally, 
if $Z$ and $Z'$ are defined for the same sequence with 
