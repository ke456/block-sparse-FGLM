...
of degree less than $\deg(R_n)$; this is known as the {\em shape
 ...
 and then to convert it to a more readable output, such as a lexicographic
...
\cite[Theorems~4.7 to~4.10]{Turner02}), using however the
...
in \cref{eq:OmegaOmega} follows at once from the definitions:
\begin{align*}
