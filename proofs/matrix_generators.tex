...
application: a (finite) bound on the degree of a minimal generating matrix.
Note that a bound on the determinantal degree $\degDet$ is sufficient since any
minimal generating matrix will have degree less than this; yet better bounds
can be available and will imply better efficiency.
...
\begin{problembox}[htbp]
  ...
  \dataInfos{Assumptions}{%itemize
    ...
    \item any minimal matrix generator of $\seq$ has degree at most $\degBd$.
  }
